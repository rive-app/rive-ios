...
- (void)testNumberInput {
    ...
    XCTAssertTrue([[[stateMachineInstance inputFromName: @"Number 1" error:nil] name] isEqualToString:@"Number 1"]);
...
- (void)testBooleanInput {
    ...
    XCTAssertTrue([[[stateMachineInstance inputFromName: @"Boolean 1" error:nil] name] isEqualToString:@"Boolean 1"]);
...
- (void)testTriggerInput {
    ...
    XCTAssertTrue([[[stateMachineInstance inputFromName: @"Trigger 1" error:nil] name] isEqualToString:@"Trigger 1"]);
...
- (void)testMixedInput {
    ...
    XCTAssertEqual([[stateMachineInstance inputFromName:@"two_point_two" error:nil] isNumber], true);
    ...
    XCTAssertEqual([[stateMachineInstance inputFromName:@"zero" error:nil] isKindOfClass:[RiveSMINumber class]], true);
    XCTAssertEqual([(RiveSMINumber *)[stateMachineInstance inputFromName:@"zero" error:nil] value], 0);
    XCTAssertEqual([[stateMachineInstance inputFromName:@"two_point_two" error:nil] isKindOfClass:[RiveSMINumber class]], true);
    XCTAssertEqual([(RiveSMINumber *)[stateMachineInstance inputFromName:@"two_point_two" error:nil] value], (float)2.2);
    XCTAssertEqual([[stateMachineInstance inputFromName:@"three" error:nil] isKindOfClass:[RiveSMINumber class]], true);
    XCTAssertEqual([(RiveSMINumber *)[stateMachineInstance inputFromName:@"three" error:nil] value], (float)3);
    
    XCTAssertEqual([[stateMachineInstance inputFromName:@"on" error:nil] isKindOfClass:[RiveSMIBool class]], true);
    XCTAssertEqual([(RiveSMIBool *)[stateMachineInstance inputFromName:@"on" error:nil] value], true);
    XCTAssertEqual([[stateMachineInstance inputFromName:@"off" error:nil] isKindOfClass:[RiveSMIBool class]], true);
    XCTAssertEqual([(RiveSMIBool *)[stateMachineInstance inputFromName:@"off" error:nil] value], false);
    
    XCTAssertEqual([[stateMachineInstance inputFromName:@"trigger" error:nil] isKindOfClass:[RiveSMITrigger class]], true);
}
